 ...
 *  - 乗車名：乗車名マスタから自動反映し、イレギュラー時のみ社員一覧から手動選択。
...
<div class="wrap fa-wrap fa-entry">
    ...
    <p class="description" style="margin:0 0 12px;">
        1行につき1乗船分を入力してください（往復した場合は2行）。車番を入力すると乗車名が自動表示され、例外時は「手動選択」で変更できます。
    </p>
        ...
        <table class="fa-table fa-entry-table" id="fa-entry-table">
            <thead>
                <tr>
                    ...
                    <th style="width:16em;">乗車名<span class="fa-req">*</span></th>
